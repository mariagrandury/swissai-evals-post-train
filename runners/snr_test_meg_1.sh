#!/bin/bash
# SNR stage runner - GENERATED from configs/signal_to_ratio/models_test_megatron.txt (selection: --last 1)
# Regenerate: bash scripts/generate_snr_runner.sh --models configs/signal_to_ratio/models_test_megatron.txt --last 1 > $0
